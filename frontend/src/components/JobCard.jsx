import { Bookmark, BriefcaseBusiness, Clock, IndianRupee, MapPin, ScrollText, User } from 'lucide-react';
...
const JobCard = ({ job }) => {
    ...
    return (
        <div className='flex flex-col gap-4 p-4 w-[95%] shadow-lg hover:shadow-xl md:hover:shadow-2xl transition-shadow rounded-lg bg-white'>
